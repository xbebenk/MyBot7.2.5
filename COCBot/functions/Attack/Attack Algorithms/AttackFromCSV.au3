...
;~ 		For $i = 0 To 4
;~ 			SetLog("$g_aaiTopLeftDropPoints[" & $i & "]: " & $g_aaiTopLeftDropPoints[$i][0] & "," & $g_aaiTopLeftDropPoints[$i][1])
;~ 		Next
;~ 		For $i = 0 To 4
;~ 			SetLog("$g_aaiTopRightDropPoints[" & $i & "]: " & $g_aaiTopRightDropPoints[$i][0] & "," & $g_aaiTopRightDropPoints[$i][1])
;~ 		Next
;~ 		For $i = 0 To 4
;~ 			SetLog("$g_aaiBottomLeftDropPoints[" & $i & "]: " & $g_aaiBottomLeftDropPoints[$i][0] & "," & $g_aaiBottomLeftDropPoints[$i][1])
;~ 		Next
;~ 		For $i = 0 To 4
;~ 			SetLog("$g_aaiBottomRightDropPoints[" & $i & "]: " & $g_aaiBottomRightDropPoints[$i][0] & "," & $g_aaiBottomRightDropPoints[$i][1])
;~ 		Next
;~ 	EndIf
	;===========================
